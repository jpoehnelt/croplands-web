...
//            templateUrl: 'http://cache.croplands.org/templates/home.html',
            ...
            templateUrl: 'http://cache.croplands.org/templates/map.html',
...
//        templateUrl: 'http://cache.croplands.org/templates/directives/filter.html'
    };
...
app.directive('forgotForm', ['user', 'log', '$timeout', function (user, log, $timeout) {
    return {
        ...
        templateUrl: '/templates/directives/forgot.html'
//        templateUrl: 'http://cache.croplands.org/templates/directives/forgot.html'
    };
...
//        templateUrl: '/templates/directives/legend.html'
        templateUrl: 'http://cache.croplands.org/templates/directives/legend.html'
    };
}]);;
...
//        templateUrl: 'http://cache.croplands.org/templates/directives/location.html'
    };
...
//        templateUrl: '/templates/directives/location-record.html'
        templateUrl: '/templates/directives/location-record.html'
    };
}]);;
...
//        templateUrl: '/templates/directives/location-record-edit-form.html'
        templateUrl: '/templates/directives/location-record-edit-form.html'
    };
}]);;
...
//        templateUrl: '/templates/directives/location-record-list.html'
        templateUrl: '/templates/directives/location-record-list.html'
    };
}]);;
...
//        templateUrl: 'http://cache.croplands.org/templates/directives/log.html'
    };
}]);
;
...
//        templateUrl: 'http://cache.croplands.org/templates/directives/login.html'
    };
...
app.directive('ndvi', ['version', '$http', '$log', '$q', function (version, $http, $log, $q) {
    ...
    return {
        ...
        templateUrl: '/templates/directives/ndvi.html'
//        templateUrl: 'http://cache.croplands.org/templates/directives/ndvi.html'
    };
...
app.directive('passwordConfirm', ['$window', function ($window) {
    ...
    return {
        ...
        templateUrl: '/templates/directives/password-confirm.html'
//        templateUrl: 'http://cache.croplands.org/templates/directives/password-confirm.html'
    }
        ;
}])
;
...
//        templateUrl: 'http://cache.croplands.org/templates/directives/photos.html'
    };
...
//        templateUrl: 'http://cache.croplands.org/templates/directives/register.html'
    };
...
app.directive('resetForm', ['user', '$window', '$timeout', function (user, $window, $timeout) {
    return {
        ...
        templateUrl: '/templates/directives/reset.html'
//        templateUrl: 'http://cache.croplands.org/templates/directives/reset.html'
    };

}]);;
angular.module('templates-main', ['index.html', 'views/404.html', 'views/directives/filter.html', 'views/directives/forgot.html', 'views/directives/legend.html', 'views/directives/location-record-edit-form.html', 'views/directives/location-record-list.html', 'views/directives/location-record.html', 'views/directives/location.html', 'views/directives/log.html', 'views/directives/login.html', 'views/directives/ndvi.html', 'views/directives/password-confirm.html', 'views/directives/photos.html', 'views/directives/register.html', 'views/directives/reset.html', 'views/game.html', 'views/home.html', 'views/map.html', 'views/reset.html']);
...
angular.module("index.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("index.html",
    ...
    "    <base href=\"/\">\n" +
    "\n" +
    "    <title>Global Food Security Analysis-Support Data Project</title>\n" +
    "\n" +
    "    <!-- CSSS -->\n" +
    "    <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css'>\n" +
    "    <link href=\"//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css\"\n" +
    "          rel=\"stylesheet\">\n" +
    "    <link rel=\"stylesheet\" href=\"/static/css/main.@@version.min.css\">\n" +
    "\n" +
    ...
    "    <script src=\"//cdnjs.cloudflare.com/ajax/libs/angular.js/1.3.5/angular.min.js\"></script>\n" +
    "    <script src=\"//cdnjs.cloudflare.com/ajax/libs/angular.js/1.3.5/angular-route.min.js\"></script>\n" +
    ...
    "    <script src=\"/static/js/app.@@version.min.js\"></script>\n" +
    "\n" +
    "</head>\n" +
    "\n" +
    "<body ng-controller=\"MasterController\" id=\"top\">\n" +
    "\n" +
    ...
    "                <span class=\"icon-bar\"></span>\n" +
    "            </button>\n" +
    "            <a class=\"navbar-brand\" target=\"_self\" href=\"/\">Global Croplands</a>\n" +
    "        </div>\n" +
    "        <div class=\"collapse navbar-collapse\">\n" +
    "            <ul class=\"nav navbar-nav\">\n" +
    "                <li><a target=\"_self\" href=\"/map\">Map</a></li>\n" +
    "                <li><a target=\"_self\" href=\"/#Data\">Data</a></li>\n" +
    "                <li><a target=\"_self\" href=\"/#Methods\">Methods</a></li>\n" +
    ...
    "\n" +
    "                <li ng-show=\"!isLoggedIn()\" ng-click=\"goToLogin()\"><a>Login</a></li>\n" +
    ...
    "                        <li><a ng-click=\"logout()\" blur>Logout</a></li>\n" +
    "                    </ul>\n" +
    "                </li>\n" +
    "            </ul>\n" +
    "            <button class=\"pull-right navbar-btn btn btn-default disabled\"\n" +
    "                    style=\"margin-right: 10px;\">Beta Version\n" +
    "            </button>\n" +
    "        </div>\n" +
    "        <!--/.nav-collapse -->\n" +
    "    </div>\n" +
    ...
    "</div>\n" +
    "\n" +
    "<login-form ng-show=\"login\" class=\"am-fade-scale\"></login-form>\n" +
    "<register-form ng-show=\"register\" class=\"am-fade\"></register-form>\n" +
    "<forgot-form ng-show=\"forgot\" class=\"am-fade\"></forgot-form>\n" +
    "\n" +
    "\n" +
...
angular.module("views/404.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/404.html",
    "<div style=\"height:100px; line-height:100px;font-size:30px;width: 600px;margin: 20px auto;color:#666666;\">\n" +
    "    <span style=\"font-size:300%;vertical-align:middle;\">404</span>\n" +
    "    <span style=\"vertical-align:middle;\"> - This page does not exist!</span>\n" +
    "</div>\n" +
    "<div class=\"center-block\" style=\"width: 600px\">\n" +
    "    <img width=\"600\"\n" +
    "         src=\"http://landsat.gsfc.nasa.gov/wp-content/uploads/2013/01/ldcm_2012_COL.png\"/>\n" +
    "\n" +
    "    <p style=\"font-style: italic;margin-top:20px\">Landsat 8 launched on February 11, 2013, from\n" +
    "        Vandenberg Air Force Base, California,\n" +
    "        on an Atlas-V 401 rocket, with the extended payload fairing  (EPF) from United\n" +
    "        Launch Alliance, LLC. The Landsat 8 satellite payload consists of two science\n" +
    "        instruments—the Operational Land Imager (OLI) and the Thermal Infrared Sensor\n" +
    ...
    "        meters (panchromatic).</p>\n" +
    "    <small>Angularjs</small>\n" +
    "</div>");
}]);

angular.module("views/directives/filter.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/filter.html",
    "<div class=\"control\" id=\"filters\">\n" +
    "    <div class=\"panel panel-primary am-slide-left\">\n" +
    "        <div class=\"panel-heading clearfix\">\n" +
    "            <i class=\"fa fa-close\" ng-click=\"visible = !visible\"></i>\n" +
    "            <h5 class=\"panel-title\"> <i class=\"fa fa-fw fa-filter\"></i> Map Filters</h5>\n" +
    "        </div>\n" +
    "        <div class=\"panel-body\">\n" +
    "\n" +
    "            <div class=\"well well-xs\">\n" +
    "                <div class=\"btn-group btn-group-justified\" role=\"group\" aria-label=\"...\">\n" +
    "                    <div class=\"btn-group\" role=\"group\" ng-repeat=\"type in landUseType\">\n" +
    "                        <button type=\"button\"\n" +
    "                                ng-click=\"type.selected = !type.selected\"\n" +
    "                                ng-class=\"{'active': type.selected}\"\n" +
    ...
    "\n" +
    "            <div class=\"well well-xs\">\n" +
    "                <button class=\"btn btn-primary btn-xs btn-crop\"\n" +
    "                        ng-click=\"toggleAllOptions('years')\"\n" +
    "                        blur>\n" +
    "                    <i class=\"fa fa-fw fa-square-o\" ng-show=\"!allOptionsAreSelected('years')\"></i>\n" +
    "                    <i class=\"fa fa-fw fa-check-square-o\" ng-show=\"allOptionsAreSelected('years')\"></i>\n" +
    "                </button>\n" +
    "                <button class=\"btn btn-primary btn-xs btn-crop\"\n" +
    "                        ng-class=\"{'active': year.selected}\"\n" +
    "                        ng-repeat=\"year in years\"\n" +
    "                        ng-click=\"year.selected = !year.selected\"\n" +
    "                        blur>{{ year.label }}</button>\n" +
    "            </div>\n" +
    "            <div class=\"well well-xs\">\n" +
    "                <div class=\"btn-group btn-group-justified\" role=\"group\" aria-label=\"...\">\n" +
    "\n" +
    "                    <div class=\"btn-group\" role=\"group\" ng-repeat=\"intensityLevel in intensity\">\n" +
    "                        <button type=\"button\"\n" +
    "                                ng-click=\"intensityLevel.selected = !intensityLevel.selected\"\n" +
    "                                ng-class=\"{'active': intensityLevel.selected}\"\n" +
    ...
    "            <div class=\"well well-xs\">\n" +
    "                <div class=\"btn-group btn-group-justified\" role=\"group\" aria-label=\"...\">\n" +
    "                    <div class=\"btn-group\" role=\"group\" ng-repeat=\"waterUseType in water\">\n" +
    "                        <button type=\"button\"\n" +
    "                                ng-click=\"waterUseType.selected = !waterUseType.selected\"\n" +
    "                                ng-class=\"{'active': waterUseType.selected}\"\n" +
    ...
    "            <div class=\"well well-xs\">\n" +
    "\n" +
    "                <button class=\"btn btn-success btn-xs btn-crop\"\n" +
    "                        ng-click=\"toggleAllOptions('crops')\"\n" +
    "                        blur>\n" +
    "                    <i class=\"fa fa-fw fa-square-o\" ng-show=\"!allOptionsAreSelected('crops')\"></i>\n" +
    "                    <i class=\"fa fa-fw fa-check-square-o\" ng-show=\"allOptionsAreSelected('crops')\"></i>\n" +
    "\n" +
    "                </button>\n" +
    "\n" +
    "                <button class=\"btn btn-success btn-xs btn-crop\"\n" +
    "                        ng-class=\"{'active': crop.selected}\"\n" +
    "                        ng-repeat=\"crop in crops\"\n" +
    "                        ng-click=\"crop.selected = !crop.selected\"\n" +
    "                        blur>{{ crop.label }}</button>\n" +
    "            </div>\n" +
    "\n" +
    "        </div>\n" +
    "        <div class=\"panel-footer\" style=\"text-align: right\">\n" +
    "            <small style=\"margin-right: 20px;\">Total: {{ countAll | number }} &nbsp;\n" +
    "                Filtered: {{ countFiltered | number }}\n" +
    "                <i class=\"fa fa-exclamation-triangle\"\n" +
    "                   ng-show=\"filteredRecords > filteredMarkers\"\n" +
    "                   data-title=\"Max of 10,000\"\n" +
    "                   data-placement=\"left\"\n" +
    "                   bs-tooltip></i></small>\n" +
    "            <button class=\"btn btn-default btn-xs\" ng-click=\"reset()\" blur>Reset</button>\n" +
    "            <button class=\"btn btn-primary btn-xs\" ng-click=\"apply()\" blur>Apply</button>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>");
}]);

angular.module("views/directives/forgot.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/forgot.html",
    "<div class=\"modal modal-bg\">\n" +
    "    <div class=\"modal-dialog modal-sm\">\n" +
    "        <div class=\"panel panel-primary\">\n" +
    "            <div class=\"panel-heading clearfix\">\n" +
    "                <i class=\"fa fa-close panel-close\" ng-click=\"close()\"></i>\n" +
    "                <h5 class=\"panel-title panel-float\">Forgot Password</h5>\n" +
    "            </div>\n" +
    "            <div class=\"panel-body\">\n" +
    "                <form name=\"forgotForm\" ng-hide=\"success\">\n" +
    ...
    "                    </div>\n" +
    "                    <div class=\"form-group\">\n" +
    "                        <button class=\"btn btn-block btn-default btn-primary\"\n" +
    "                                ng-class=\"{'disabled': busy || !forgotForm.$valid}\"\n" +
    "                                ng-click=\"forgot()\" blur>\n" +
    "                            Send Reset Link\n" +
    "                        </button>\n" +
    "                    </div>\n" +
    "                </form>\n" +
    ...
    "                    <strong ng-show=\"success\">Success!</strong>\n" +
    "                    <strong ng-show=\"!success\">Error!</strong>\n" +
    "                    {{ message }}\n" +
    "                </div>\n" +
    "                <button class=\"btn btn-sm btn-default btn-default\"\n" +
    "                        ng-click=\"login()\"\n" +
    "                        blur>\n" +
    "                    Login\n" +
    "                </button>\n" +
...
angular.module("views/directives/legend.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/legend.html",
    "<div ng-repeat=\"item in items\" class=\"clearfix\" style=\"margin-bottom: 2px;\">\n" +
    "    <div class=\"pull-left\" style=\"background-color:{{ item.color }};width:20px;height:15px;\"></div>\n" +
    "    <div style=\"font-size: 11px;margin-left: 23px;\">{{ item.label }}</div>\n" +
    "</div>\n" +
    "\n" +
    "");
}]);

angular.module("views/directives/location-record-edit-form.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/location-record-edit-form.html",
    "<div class=\"form-group\">\n" +
    "    <label for=\"year\">Year</label>\n" +
    "    <select name=\"year\" class=\"form-control input-sm\"\n" +
    "            ng-model=\"record.year\"\n" +
    "            ng-options=\"year.id as year.label for year in years\">\n" +
    "    </select>\n" +
    "</div>\n" +
    "<div class=\"form-group\">\n" +
    "    <label for=\"year\">Land Use Type</label>\n" +
    "    <select name=\"year\" class=\"form-control input-sm\"\n" +
    "            ng-model=\"record.land_use_type\"\n" +
    "            ng-options=\"type.id as type.label for type in landUseTypes\">\n" +
    "    </select>\n" +
    "</div>\n" +
    "<div class=\"am-fade\" ng-show=\"record.land_use_type === 1\">\n" +
    "    <div class=\"form-group\">\n" +
    "        <label for=\"year\">Water Source</label>\n" +
    "        <select name=\"year\" class=\"form-control input-sm\"\n" +
    "                ng-model=\"record.water\"\n" +
    "                ng-options=\"w.id as w.label for w in water\">\n" +
    "        </select>\n" +
    "    </div>\n" +
    "    <div class=\"form-group\">\n" +
    "        <label for=\"year\">Crop Intensity</label>\n" +
    "        <select name=\"year\" class=\"form-control input-sm\"\n" +
    "                ng-model=\"record.intensity\"\n" +
    "                ng-options=\"i.id as i.label for i in intensity\">\n" +
    "        </select>\n" +
    "    </div>\n" +
    "    <div class=\"form-group\">\n" +
    "        <label for=\"year\">Primary Crop</label>\n" +
    "        <select name=\"year\" class=\"form-control input-sm\"\n" +
    "                ng-model=\"record.crop_primary\"\n" +
    "                ng-options=\"crop.id as crop.label for crop in crops\">\n" +
    "        </select>\n" +
    "    </div>\n" +
    "    <div class=\"form-group\">\n" +
    "        <label for=\"year\">Secondary Crop</label>\n" +
    "        <select name=\"year\" class=\"form-control input-sm\"\n" +
    "                ng-model=\"record.crop_secondary\"\n" +
    "                ng-options=\"crop.id as crop.label for crop in crops\">\n" +
    "        </select>\n" +
    "    </div>\n" +
    "</div>\n" +
    "<div class=\"right\">\n" +
    "    <button class=\"btn btn-primary btn-sm\" ng-click=\"save()\" blur>\n" +
    "        <icon class=\"fa fa-fw fa-save\"></icon>\n" +
    "        Save\n" +
    "    </button>\n" +
    "    <button class=\"btn btn-default btn-sm\" ng-click=\"cancel()\" blur> Cancel</button>\n" +
    "</div>\n" +
    "");
}]);

angular.module("views/directives/location-record-list.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/location-record-list.html",
    "<div data-location-record data-record=\"record\" data-show-zoom=\"showZoom\" ng-repeat=\"record in pagedRecords[page]\">\n" +
    "</div>\n" +
    "\n" +
    "\n" +
    "<nav class=\"center\" ng-show=\"pagedRecords.length > 1\">\n" +
    "    <ul class=\"pagination pagination-sm\">\n" +
    "        <li ng-class=\"{'disabled': page === 0}\">\n" +
    "            <a ng-click=\"setPage(0)\" blur>\n" +
    "                <icon class=\"fa fa-fw fa-fw fa-angle-double-left\"></icon>\n" +
    "            </a>\n" +
    "        </li>\n" +
    "        <li ng-class=\"{'disabled': page ===0}\">\n" +
    "            <a ng-click=\"previous()\" blur>\n" +
    "                <icon class=\"fa fa-fw fa-angle-left\"></icon>\n" +
    "            </a>\n" +
    "        </li>\n" +
    "        <li ng-repeat=\"n in range(pagedRecords.length)\" ng-click=\"setPage(n)\"\n" +
    "            ng-class=\"{'active': n === page}\"\n" +
    "            ng-if=\"n + 1 >=page && n <= page|| n-1 <=page && n >= page || n-2 === page || n+2 === page || page <=2 && n <=4 || page >=pagedRecords.length - 3 && n >=pagedRecords.length - 5\"\n" +
    "            blur>\n" +
    "            <a href ng-bind=\"n + 1\"></a>\n" +
    "        </li>\n" +
    "        <li ng-class=\"{'disabled': page === pagedRecords.length - 1}\">\n" +
    "            <a ng-click=\"next()\" blur>\n" +
    "                <icon class=\"fa fa-fw fa-angle-right\"></icon>\n" +
    "            </a>\n" +
    "        </li>\n" +
    "        <li ng-class=\"{'disabled': page === pagedRecords.length - 1}\">\n" +
    "            <a ng-click=\"setPage(pagedRecords.length - 1)\" blur>\n" +
    "                <icon class=\"fa fa-fw fa-angle-double-right\"></icon>\n" +
    "            </a>\n" +
    "        </li>\n" +
    "    </ul>\n" +
    "</nav>\n" +
    "<span class=\"center small\" ng-hide=\"pagedRecords.length\">No data to display.</span>");
}]);

angular.module("views/directives/location-record.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/location-record.html",
    "<div class=\"map-record\" ng-class=\"{'active': showEditForm, 'new': !record.id}\">\n" +
    "    <div class=\"row row-condensed\">\n" +
    "        <div class=\"col-xs-3 center\">\n" +
    "            <div class=\"year\">{{ record.year }} {{ record.month | monthName }}\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"col-xs-6\">\n" +
    "            <div class=\"details center\">\n" +
    "                     <span ng-show=\"record.land_use_type !== 1\">\n" +
    "                        {{ record.land_use_type | mappings: 'landUseType' }}\n" +
    "                    </span>\n" +
    "                    <span ng-show=\"record.land_use_type === 1\">\n" +
    "                        {{ record.water | mappings: 'water' }}\n" +
    "                        {{ record.intensity | mappings: 'intensity' }}\n" +
    "                        {{ record.crop_primary | mappings: 'crop' }}\n" +
    "                    </span>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"col-xs-3 right\">\n" +
    "            <icon class=\"fa fa-fw fa-edit fa-btn\" ng-click=\"edit()\" blur></icon>\n" +
    "            <icon class=\"fa fa-fw fa-search-plus fa-btn\" ng-click=\"zoom()\"\n" +
    "                  ng-show=\"showZoom\"></icon>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>\n" +
    "");
...
angular.module("views/directives/location.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/location.html",
    ...
    "                           ng-click=\"changeActiveTab('photos')\"\n" +
    "                           ng-class=\"{ active: activeTab === 'photos', 'disabled': location.photos === undefined || location.photos.length === 0}\"\n" +
    ...
    "                        </div>\n" +
    "\n" +
    "                        <div class=\"photos\" ng-show=\"activeTab === 'photos'\" ng-cloak>\n" +
    "                            <div ng-show=\"!editLoading\">\n" +
    "                                <photos items=\"location.photos\"\n" +
    "                                        ng-show=\"location.photos && location.photos.length >= 1\"></photos>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    ...
    "                                you have feedback,\n" +
    "                                contact\n" +
    "                                us at info@land_use_types.org.</p>\n" +
    "\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "\n" +
    ...
    "                            data-placement=\"top\"\n" +
    "                            bs-tooltip><i class=\"fa fa-fw fa-search-plus\"></i></button>\n" +
    "\n" +
    "                    </span>\n" +
    "        </div>\n" +
    "    </div>\n" +
...
angular.module("views/directives/log.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/log.html",
    "<ul class=\"list-unstyled\">\n" +
    "    <li ng-repeat=\"item in list | orderBy: date\">{{ item.message }}</li>\n" +
    "</ul>");
}]);

angular.module("views/directives/login.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/login.html",
    "<div class=\"modal modal-bg\">\n" +
    "    <div class=\"modal-dialog modal-sm\">\n" +
    "        <div class=\"panel panel-primary\">\n" +
    "            <div class=\"panel-heading clearfix\">\n" +
    "                <i class=\"fa fa-close panel-close\" ng-click=\"loginClose()\"></i>\n" +
    "                <h5 class=\"panel-title panel-float\">Login</h5>\n" +
    "            </div>\n" +
    "            <div class=\"panel-body\">\n" +
    "                <form name=\"loginForm\">\n" +
    "                    <div class=\"form-group hidden\">\n" +
    "                        <button class=\"btn btn-google\">\n" +
    "                            <icon class=\"fa fa-fw fa-google fa-border-right\"></icon>\n" +
    "                            Google\n" +
    "                        </button>\n" +
    "                        <button class=\"btn btn-facebook\">\n" +
    "                            <icon class=\"fa fa-fw fa-facebook fa-border-right\"></icon>\n" +
    "                            Facebook\n" +
    "                        </button>\n" +
    "                    </div>\n" +
    "                    <div class=\"form-group\">\n" +
    ...
    "                    <div class=\"form-group\">\n" +
    "                        <button class=\"btn btn-block btn-default btn-primary\"\n" +
    "                                ng-class=\"{'disabled': busy || !loginForm.$valid}\"\n" +
    "                                ng-click=\"login(loginForm.$valid)\" blur>\n" +
    "                            Login\n" +
    "                        </button>\n" +
    "                    </div>\n" +
    "                    <div class=\"alert\"\n" +
    ...
    "\n" +
    "                </form>\n" +
    "                <button class=\"btn btn-sm btn-default btn-default\" ng-click=\"forgot()\" blur>\n" +
    "                    Forgot\n" +
    "                </button>\n" +
    "                <button class=\"btn btn-sm btn-default btn-default\"\n" +
    "                        ng-click=\"register()\" blur>Register\n" +
    "                </button>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>\n" +
...
angular.module("views/directives/ndvi.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/ndvi.html",
    "<div class=\"am-fade\" ng-hide=\"ndviBusy\">\n" +
    "    <h5>NDVI Time Series<small>MOD13Q1</small></h5>\n" +
    "    <svg version=\"1.1\" id=\"ndvi-svg\" xmlns=\"http://www.w3.org/2000/svg\"\n" +
    "	 viewBox=\"0 0 400 280\" style=\"width: 100%;\" xml:space=\"preserve\">\n" +
    "\n" +
    "\n" +
    "        <polyline class=\"axis\" fill=\"none\" stroke=\"#000000\" points=\"20,10 20,220 400,220 \"></polyline>\n" +
    "        <g class=\"time-series\">\n" +
    "            <g ng-repeat=\"(year, data) in series\">\n" +
    "                <polyline class=\"{{ data.class }}\"\n" +
    "                          ng-mouseover=\"activate(year)\"\n" +
    "                          ng-mouseleave=\"deactivate()\"\n" +
    "                          fill=\"none\"\n" +
    "                          stroke=\"{{ data.color }}\"\n" +
    "                          ng-attr-points=\"{{ data.points }}\"></polyline>\n" +
    "            </g>\n" +
    "        </g>\n" +
    "        <g class=\"horizontal-labels\">\n" +
    "            <text x=\"0\" y=\"20\" alignment-baseline=\"middle\">1</text>\n" +
    "            <text x=\"0\" y=\"220\" alignment-baseline=\"middle\">0</text>\n" +
    "        </g>\n" +
    "        <g class=\"vertical-grids hidden\">\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"45,20 45,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"75,20 75,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"105,20 105,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"135,20 135,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"165,20 165,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"195,20 195,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"225,20 225,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"255,20 255,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"285,20 285,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"315,20 315,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"345,20 345,220\"></polyline>\n" +
    "            <polyline stroke=\"#dddddd\" file=\"none\" points=\"375,20 375,220\"></polyline>\n" +
    "        </g>\n" +
    "        <g class=\"vertical-labels\">\n" +
    "            <text x=\"45\" y=\"230\" transform=\"rotate(90, 45, 230)\" alignment-baseline=\"middle\">Jan</text>\n" +
    "            <text x=\"75\" y=\"230\" transform=\"rotate(90, 75, 230)\" alignment-baseline=\"middle\">Feb</text>\n" +
    "            <text x=\"105\" y=\"230\" transform=\"rotate(90, 105, 230)\" alignment-baseline=\"middle\">Mar</text>\n" +
    "            <text x=\"135\" y=\"230\" transform=\"rotate(90, 135, 230)\" alignment-baseline=\"middle\">Apr</text>\n" +
    "            <text x=\"165\" y=\"230\" transform=\"rotate(90, 165, 230)\" alignment-baseline=\"middle\">May</text>\n" +
    "            <text x=\"195\" y=\"230\" transform=\"rotate(90, 195, 230)\" alignment-baseline=\"middle\">Jun</text>\n" +
    "            <text x=\"225\" y=\"230\" transform=\"rotate(90, 225, 230)\" alignment-baseline=\"middle\">Jul</text>\n" +
    "            <text x=\"255\" y=\"230\" transform=\"rotate(90, 255, 230)\" alignment-baseline=\"middle\">Aug</text>\n" +
    "            <text x=\"285\" y=\"230\" transform=\"rotate(90, 285, 230)\" alignment-baseline=\"middle\">Sep</text>\n" +
    "            <text x=\"315\" y=\"230\" transform=\"rotate(90, 315, 230)\" alignment-baseline=\"middle\">Oct</text>\n" +
    "            <text x=\"345\" y=\"230\" transform=\"rotate(90, 345, 230)\" alignment-baseline=\"middle\">Nov</text>\n" +
    "            <text x=\"375\" y=\"230\" transform=\"rotate(90, 375, 230)\" alignment-baseline=\"middle\">Dec</text>\n" +
    "        </g>\n" +
    "    </svg>\n" +
    "    <div class=\"clearfix\" style=\"padding-left: 20px;\">\n" +
    "        <small class=\"pull-left year-label\" style=\"margin: 0 10px;\" ng-repeat=\"(year, data) in series\"\n" +
    "               ng-mouseover=\"activate(year)\"\n" +
    "               ng-mouseleave=\"deactivate()\"><span ng-class=\"{'inactive': data.class==='inactive'}\">{{ year }}</span>\n" +
    "        <icon class=\"fa fa-square\" ng-style=\"{ 'color': data.color }\"></icon>\n" +
    "        </small>\n" +
    "    </div>\n" +
    "</div>");
}]);

angular.module("views/directives/password-confirm.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/password-confirm.html",
    "<div class=\"form-group\">\n" +
    ...
    "    <input class=\"form-control\" ng-model=\"confirm\"\n" +
    "           name=\"confirm\"\n" +
    "           type=\"password\"\n" +
    "           value=\"\"\n" +
    "           placeholder=\"Password\" required>\n" +
    "</div>\n" +
    "<div>\n" +
    "    <p ng-class=\"passwordIsStrong() ? 'text-success' : 'text-danger'\">\n" +
    "        <icon class=\"fa fa-fw\"\n" +
    "              ng-class=\"passwordIsStrong() ? 'fa-check' : 'fa-times'\"></icon>\n" +
    "        Password is sufficiently strong.\n" +
    "    </p>\n" +
    "    <p ng-class=\"passwordsMatch() ? 'text-success' : 'text-danger'\">\n" +
    "        <icon class=\"fa fa-fw\"\n" +
    "              ng-class=\"passwordsMatch() ? 'fa-check' : 'fa-times'\"></icon>\n" +
    "        Passwords match.\n" +
    "    </p>\n" +
    "</div>");
}]);

angular.module("views/directives/photos.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/photos.html",
    "<div class=\"thumbnail\">\n" +
    "    <img ng-src=\"{{ src(active.url) }}\" class=\"img-responsive\">\n" +
    "    <div class=\"caption-tight small\">{{ active.date_taken | date : mediumDate }}</div>\n" +
    "</div>\n" +
    "\n" +
    "<div class=\"row\">\n" +
    "    <div ng-repeat=\"photo in items | orderBy:'date_taken':true | limitTo: 12 \" class=\"col-sm-3\">\n" +
    "        <a ng-click=\"changeLeadPhoto($index)\" class=\"thumbnail\">\n" +
    "            <img ng-src=\"{{ src(photo.url) }}\">\n" +
    "        </a>\n" +
    "    </div>\n" +
    "</div>\n" +
    "\n" +
...
angular.module("views/directives/register.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/register.html",
    "<div class=\"modal modal-bg\" >\n" +
    "    <div class=\"modal-dialog\">\n" +
    "        <div class=\"panel panel-primary\">\n" +
    "            <div class=\"panel-heading clearfix\">\n" +
    "                <i class=\"fa fa-close panel-close\" ng-click=\"registerClose()\"></i>\n" +
    "                <h5 class=\"panel-title panel-float\">Register</h5>\n" +
    "            </div>\n" +
    "            <div class=\"panel-body\">\n" +
    ...
    "                                       ng-model=\"registration.last\"\n" +
    "                                       placeholder=\"Last Name\"\n" +
    "                                       required>\n" +
    "                            </div>\n" +
    "                            <div class=\"form-group\">\n" +
    "                                <label for=\"organization\">Organization <span class=\"small\">(Optional)</span></label>\n" +
    "                                <input class=\"form-control\" id=\"organization\" name=\"organization\"\n" +
    "                                       type=\"text\"\n" +
    "                                       ng-model=\"registration.organization\"\n" +
    "                                       placeholder=\"Organization\"\n" +
    "                                        >\n" +
    "                            </div>\n" +
    "                            <div class=\"form-group\">\n" +
    "                                <label for=\"country\">Country <span class=\"small\">(Optional)</span></label>\n" +
    "                                <select id=\"country\" class=\"form-control\"\n" +
    "                                        ng-options=\"c for c in countries\"\n" +
    "                                        ng-model=\"registration.country\"></select>\n" +
    "                            </div>\n" +
    "\n" +
    "                        </div>\n" +
    "                        <div class=\"col-sm-6\">\n" +
    ...
    "                                       required>\n" +
    "                            </div>\n" +
    "                            <div data-password-confirm data-valid=\"registration.passwordValid\"\n" +
    "                                 data-min-entropy=\"30\"\n" +
    "                                 data-password=\"registration.password\">\n" +
    "                            </div>\n" +
    "                            <p ng-class=\"registrationForm.email.$valid ? 'text-success' : 'text-danger'\">\n" +
    "                                <icon class=\"fa fa-fw\"\n" +
    "                                      ng-class=\"registrationForm.email.$valid ? 'fa-check' : 'fa-times'\"></icon>\n" +
    "                                Valid email address.\n" +
    "                            </p>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    ...
    "                    <div class=\"form-group\">\n" +
    "                        <button class=\"btn btn-block btn-default btn-primary\"\n" +
    "                                ng-class=\"{'disabled': !registration.passwordValid || !registrationForm.$valid || busy}\"\n" +
    "                                ng-click=\"register()\" blur>Register\n" +
    "                        </button>\n" +
    "                    </div>\n" +
    "                    <div class=\"alert\"\n" +
    "                         ng-show=\"registration.message.length\"\n" +
    "                         ng-class=\"{'alert-success': success, 'alert-danger': !success}\">\n" +
    "                        <strong ng-show=\"success\">Success!</strong>\n" +
    "                        <strong ng-show=\"!success\">Error!</strong>\n" +
    ...
    "\n" +
    "                </form>\n" +
    "                <button class=\"btn btn-sm btn-default btn-default\" ng-click=\"forgot()\" blur>Forgot</button>\n" +
    "                <button class=\"btn btn-sm btn-default btn-default\" ng-click=\"login()\" blur>Login</button>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "    <!-- /.modal-dialog -->\n" +
...
angular.module("views/directives/reset.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/directives/reset.html",
    "<div class=\"modal modal-bg\">\n" +
    "    <div class=\"modal-dialog modal-sm\">\n" +
    "        <div class=\"panel panel-primary\">\n" +
    "            <div class=\"panel-heading clearfix\">\n" +
    "                <i class=\"fa fa-close panel-close\" ng-click=\"close()\"></i>\n" +
    "                <h5 class=\"panel-title panel-float\">Change Password</h5>\n" +
    "            </div>\n" +
    "            <div class=\"panel-body\">\n" +
    "                <form name=\"resetForm\">\n" +
    "                    <div data-password-confirm data-valid=\"passwordValid\"\n" +
    "                         data-min-entropy=\"30\"\n" +
    "                         data-password=\"password\">\n" +
    "                    </div>\n" +
    "                    <div class=\"form-group\">\n" +
    "                        <button class=\"btn btn-block btn-default btn-primary\"\n" +
    "                                ng-class=\"{'disabled': !passwordValid || !resetForm.$valid || busy}\"\n" +
    "                                ng-click=\"reset()\" blur>Change\n" +
    "                        </button>\n" +
    "                    </div>\n" +
    "                    <div class=\"alert\"\n" +
    "                         ng-show=\"message.length\"\n" +
...
angular.module("views/game.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/game.html",
    "<div class=\"container container-static-nav\">\n" +
    "    <div class=\"row\" style=\"padding-top: 2%\">\n" +
    "        <div class=\"col-sm-6 col-sm-offset-1\" style=\"height:400px;\">\n" +
    "            <leaflet id=\"map\"\n" +
    "                     layers=\"layers\"\n" +
    "                     center=\"center\"\n" +
    "                     markers=\"markers\">\n" +
    ...
    "                        ng-click=\"skip()\"\n" +
    "                        ng-repeat=\"type in landUseType.choices\" blur>{{ type.label }}</button>\n" +
...
angular.module("views/home.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/home.html",
    "<div class=\"jumbotron jumbotron-banner container-static-nav\">\n" +
    "    <div class=\"container center\">\n" +
    "        <h2>Global Food Security Analysis-Support Data at 30 Meters (GFSAD30)\n" +
    "            Project</h2>\n" +
    "\n" +
    "        <p>The Overarching Goal of the GFSAD30 project is to map and produce cropland\n" +
    "            products of the\n" +
    "            world at 30 meter resolution.</p>\n" +
    "\n" +
    "        <p><a class=\"btn btn-lg btn-primary\" href=\"#About\" role=\"button\">Learn More</a>\n" +
    "\n" +
    "    </div>\n" +
    "</div>\n" +
    "\n" +
    ...
    "            <div class=\"thumbnail thumbnail-noborder center\">\n" +
    "                <a href=\"/map\">\n" +
    "                    <img class=\"img-circle\"\n" +
    "                         src=\"http://cache.croplands.org/static/images/map_box.jpg\"\n" +
    "                         alt=\"Map\">\n" +
    "                </a>\n" +
    "\n" +
    "                <h2>Global Map</h2>\n" +
    "\n" +
    "                <p>We need your help to map the world's croplands. When you contribute, you help to\n" +
    "                    refine the accuracy\n" +
    "                    of the global cropland maps!</p>\n" +
    "\n" +
    "                <p><a class=\"btn btn-danger\" href=\"/map\" role=\"button\">Contribute &raquo;</a></p>\n" +
    "\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"col-sm-6 col-md-4\">\n" +
    "            <div class=\"thumbnail thumbnail-noborder center\">\n" +
    "                <a href=\"#Methods\">\n" +
    "                    <img class=\"img-circle\" src=\"http://cache.croplands.org/static/images/sat.jpg\"\n" +
    "                         alt=\"Cropland Alogrithms\">\n" +
    "                </a>\n" +
    "\n" +
    "                <h2>Methods</h2>\n" +
    "\n" +
    "                <p>Our project uses a variety of remote sensing techniques for deriving a global\n" +
    "                    cropland map. By\n" +
    "                    remote, we mean satellite imagery!</p>\n" +
    "\n" +
    "                <p><a class=\"btn btn-danger\" href=\"#Methods\" role=\"button\">Learn More &raquo;</a>\n" +
    "                </p>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <div class=\"col-sm-6 col-md-4\">\n" +
    ...
    "                <a href=\"/#Publications\">\n" +
    "                    <img class=\"img-circle\"\n" +
    "                         src=\"http://cache.croplands.org/static/images/chart.jpg\"\n" +
    "                         alt=\"Publications\">\n" +
    "                </a>\n" +
    "\n" +
    "                <h2>Publications</h2>\n" +
    "\n" +
    "                <p>Read the relevant publications that have contributed to our work and the\n" +
    "                    'knowledge\n" +
    "                    gateway' that we\n" +
    "                    hope to provide to the the scientific community.</p>\n" +
    "\n" +
    "\n" +
    "                <p><a class=\"btn btn-danger\" href=\"#Publications\" role=\"button\">Read\n" +
    "                    More &raquo;</a>\n" +
    "                </p>\n" +
    "            </div>\n" +
    "        </div>\n" +
    ...
    "\n" +
    "                <p>The global population has just topped the 7 billion mark – a stark reminder of\n" +
    "                    the\n" +
    "                    greatest threat facing humanity in the 21st Century - food security. Society\n" +
    "                    faces\n" +
    "                    real challenges\n" +
    "                    ahead, particularly in managing water and food supplies, as well as energy, and\n" +
    "                    they are all\n" +
    "                    intimately connected in achieving global food security.</p>\n" +
    "\n" +
    "                <p>By the 2030s, the world will need 50% more food and energy and 30% more fresh\n" +
    "                    water.\n" +
    "                    So\n" +
    "                    how can we feed a burgeoning global population in a way that is both equitable\n" +
    "                    and\n" +
    "                    environmentally\n" +
    "                    sustainable? In practical terms our future will be influenced as much, if not\n" +
    "                    more,\n" +
    "                    by a rich mix of\n" +
    "                    population growth and socioeconomic development, and fundamentally by the need\n" +
    "                    to\n" +
    "                    produce more food\n" +
    "                    with fewer resources. Indeed, these factors are themselves the very reasons why\n" +
    "                    we\n" +
    "                    now face a\n" +
    "                    changing climate.</p>\n" +
    "\n" +
    "                <p>Unless a concerted effort is made and collective action taken, we risk global\n" +
    "                    food shortages, scarce water and insufficient energy - unleashing public\n" +
    "                    unrest,\n" +
    "                    cross-border conflicts and mass migration as people flee the worst-affected\n" +
    "                    regions of the world and\n" +
    "                    seek refuge in ‘safe havens.’ Additionally, with climate change, we have the\n" +
    "                    making of a ‘perfect\n" +
    "                    storm’ on the horizon. So what needs to be done?</p>\n" +
    "            </div>\n" +
    "            <div class=\"col-sm-6\">\n" +
    "                <p>Part of the answer lies in understanding global croplands, both rainfed and\n" +
    "                    irrigated,\n" +
    "                    how they are used, their extents and how they can be better managed,\n" +
    "                    particularly\n" +
    "                    since they account\n" +
    "                    for nearly 80% of all freshwater abstractions. There is a need to identify\n" +
    "                    regions\n" +
    "                    where there is\n" +
    "                    scope for improving cropland water productivity to reduce the ‘yield gap’ – the\n" +
    "                    difference between\n" +
    "                    potential and actual yield – a widespread problem constraining food production\n" +
    "                    in\n" +
    "                    both the developed\n" +
    "                    and developing world. And there is a need to understand better the links\n" +
    "                    between\n" +
    "                    food production and\n" +
    "                    water scarcity, and the impacts that climate change might have on global\n" +
    "                    croplands.\n" +
    "                    Here\n" +
    "                    technologies such as remote sensing will play an increasingly critical role –\n" +
    "                    providing new spatial\n" +
    "                    information to help manage croplands in a more productive and sustainable\n" +
    "                    way.</p>\n" +
    "\n" +
    "                <p>The GFSAD is a NASA funded project to provide high resolution global cropland\n" +
    "                    data\n" +
    "                    and\n" +
    "                    their water use that contributes towards global food security in the\n" +
    "                    twenty-first\n" +
    "                    century. The\n" +
    "                    GFSAD30 products are derived through multi-sensor remote sensing data (e.g.,\n" +
    "                    Landsat, MODIS, AVHRR),\n" +
    "                    secondary data, and field-plot data and aims at documenting cropland dynamics\n" +
    "                    from\n" +
    "                    1990 to 2017.</p>\n" +
    "\n" +
    "                <p>Read more at: <a\n" +
    "                        href=\"http://geography.wr.usgs.gov/science/croplands/index.html\">USGS.gov</a>\n" +
    "                </p>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    ...
    "\n" +
    "<div class=\"container\">\n" +
    "    <a name=\"Publications\" class=\"shifted-anchor\">&nbsp;</a>\n" +
    "\n" +
    "    <div class=\"row\">\n" +
    "        <div class=\"col-md-5\">\n" +
    "            <h2>Our Publications</h2>\n" +
    "\n" +
    "            <p class=\"lead\">Read the relevant publications that have contributed to our work and\n" +
    "                the 'knowledge\n" +
    "                gateway' that we hope to provide to the the scientific community.</p>\n" +
    "        </div>\n" +
    "        <div class=\"col-md-7\">\n" +
    "\n" +
    "            <p>Thenkabail P.S., Knox J.W., Ozdogan, M., Gumma, M.K., Congalton, R.G., Wu, Z.,\n" +
    "                Milesi, C.,\n" +
    "                Finkral, A., Marshall, M., Mariotto, I., You, S. Giri, C. and Nagler, P. 2012.\n" +
    "                Assessing future\n" +
    "                risks to agricultural productivity, water resources and food security: how can\n" +
    "                remote sensing\n" +
    "                help?. Photogrammetric Engineering and Remote Sensing, August 2012 Special Issue on\n" +
    "                Global\n" +
    "                Croplands: Highlight Article. 78(8): 773-782.</p>\n" +
    "\n" +
    "            <p>Teluguntla, P., Thenkabail, P.S., Xiong, J., Gumma, M.K., Giri, C., Milesi, C.,\n" +
    "                Ozdogan, M.,\n" +
    "                Congalton, R., Tilton, J., Sankey, T.R., Massey, R., Phalke, A., and Yadav, K.\n" +
    "                2014. Global\n" +
    "                Cropland Area Database (GCAD) derived from Remote Sensing in Support of Food\n" +
    "                Security in the\n" +
    "                Twenty-first Century: Current Achievements and Future Possibilities. Chapter 7,\n" +
    "                Vol. II. Land\n" +
    "                Resources: Monitoring, Modelling, and Mapping, Remote Sensing Handbook edited by\n" +
    "                Prasad S.\n" +
    "                Thenkabail.</p>\n" +
    "\n" +
    "        </div>\n" +
    ...
    "\n" +
    "<div class=\"container\">\n" +
    "    <a name=\"Methods\" class=\"shifted-anchor\">&nbsp;</a>\n" +
    "\n" +
    "    <div class=\"row\">\n" +
    "        <div class=\"col-md-5 hidden-sm hidden-xs\">\n" +
    "            <img class=\"centertte-image img-responsive img-rounded\"\n" +
    "                 src=\"http://cache.croplands.org/static/images/india.jpg\">\n" +
    "        </div>\n" +
    "        <div class=\"col-md-7\">\n" +
    "            <h2>Our Methods</h2>\n" +
    "\n" +
    "            <p class=\"lead\">Our map products are created with data such as Landsat and Modis\n" +
    "                imagery using\n" +
    "                remote sensing techniques by analyzing millions of image pixels.</p>\n" +
    "\n" +
    "            <p> For example, we combine temporal patterns of the Normalized Vegetation Difference\n" +
    "                Index(<a\n" +
    "                        href=\"http://en.wikipedia.org/wiki/Normalized_Difference_Vegetation_Index\">NVDI</a>)\n" +
    "                with\n" +
    "                our reference data to classify the world's cropland by the following measures.\n" +
    "                <small>(That is the very simplified version. See our <a href=\"#publications\">publications</a>\n" +
    "                    for\n" +
    "                    details.)\n" +
    "                </small>\n" +
    "            </p>\n" +
    "            <ul>\n" +
    "                <li>Cropland or NonCropland</li>\n" +
    "                <li>Irrigation or Rainfed</li>\n" +
    "                <li>Crop Types</li>\n" +
    "                <li>Intensity of Cropland</li>\n" +
    "            </ul>\n" +
    "            <p>Note: The more reference data that we have, the more that we can refine our\n" +
    "                algorithms\n" +
    "                and test their effectiveness. You can help our project by providing us with\n" +
    "                additional reference\n" +
    "                locations.</p>\n" +
    "            <blockquote>\n" +
    "                <p>Remotely sensed data provide the only source of information to make a complex\n" +
    "                    global\n" +
    "                    agricultural monitoring system feasible by being consistent, repeatable,\n" +
    "                    routine, rapid, and\n" +
    "                    scalable.</p>\n" +
    "                <footer><cite title=\"Source Title\">2012, Thenkabail, Prasad S. et al;</cite>\n" +
    "                </footer>\n" +
    "            </blockquote>\n" +
    "        </div>\n" +
    "    </div>\n" +
    ...
    "<div class=\"jumbotron jumbotron-sm\">\n" +
    "    <div class=\"container\">\n" +
    "        <a name=\"Data\" class=\"shifted-anchor\">&nbsp;</a>\n" +
    "\n" +
    "        <div class=\"row\">\n" +
    "            <div class=\"col-md-5\">\n" +
    "                <h2>Our Data</h2>\n" +
    "\n" +
    "                <p class=\"lead\"> The GFSAD products are freely available for educational, research,\n" +
    "                    or\n" +
    "                    commercial\n" +
    "                    applications. If\n" +
    "                    you wish to cite the GFSAD products in a report or publication please cite:\n" +
    "                </p>\n" +
    "\n" +
    "                <p>\n" +
    "                    <em>\n" +
    ...
    "                        Finkral,\n" +
    "                        A.,\n" +
    "                        Marshall, M., Mariotto, I., You, S. Giri, C. and Nagler, P. 2012. Assessing\n" +
    "                        future risks to\n" +
    "                        agricultural\n" +
    "                        productivity, water resources and food security: how can remote sensing\n" +
    "                        help?.\n" +
    "                        Photogrammetric\n" +
    "                        Engineering and Remote Sensing, August 2012 Special Issue on Global\n" +
    "                        Croplands:\n" +
    "                        Highlight\n" +
    "                        Article.\n" +
    "                        78(8):\n" +
    ...
    "                        Ozdogan, M.,\n" +
    "                        Congalton,\n" +
    "                        R., Tilton, J., Sankey, T.R., Massey, R., Phalke, A., and Yadav, K. 2014.\n" +
    "                        Global Cropland Area\n" +
    "                        Database\n" +
    "                        (GCAD) derived from Remote Sensing in Support of Food Security in the\n" +
    "                        Twenty-first Century:\n" +
    "                        Current\n" +
    "                        Achievements and Future Possibilities. Chapter 7, Vol. II. Land Resources:\n" +
    "                        Monitoring,\n" +
    "                        Modelling,\n" +
    "                        and\n" +
    "                        Mapping, Remote Sensing Handbook edited by Prasad S. Thenkabail.\n" +
    "                    </em>\n" +
    "                </p>\n" +
    "            </div>\n" +
    "            <div class=\"col-md-7\">\n" +
    ...
    "                        <img class=\"img-circle\"\n" +
    "                             src=\"http://cache.croplands.org/static/images/sat.jpg\"\n" +
    "                             alt=\"Map\">\n" +
    "\n" +
    "                        <h2>LP DAAC</h2>\n" +
    "\n" +
    "\n" +
    "                        <p>Download Our Data at LP DAAC.</p>\n" +
    "\n" +
    "                        <p><a class=\"btn btn-danger\"\n" +
    "                              href=\"https://lpdaac.usgs.gov/products/measures_products_table\"\n" +
    "                              role=\"button\" target=\"_blank\">USGS LP DAAC &raquo;</a>\n" +
    "                        </p>\n" +
    "                    </div>\n" +
    "                    <div class=\"col-sm-4 col-md-4 center\">\n" +
    "                        <img class=\"img-circle\"\n" +
    ...
    "\n" +
    "\n" +
    "                        <p>Our data is available through our WMS.\n" +
    "                        </p>\n" +
    "\n" +
    "                        <p><a class=\"btn btn-danger\"\n" +
    "                              href=\"http://cache.croplands.org/static/getcapabilities.xml\"\n" +
    "                              role=\"button\">View\n" +
    "                            Capabilities &raquo;</a>\n" +
    "                        </p>\n" +
    "                    </div>\n" +
    "                    <div class=\"col-sm-4 col-md-4 center\">\n" +
    "                        <img class=\"img-circle\"\n" +
    "                             src=\"http://cache.croplands.org/static/images/servers.jpg\" alt=\"Map\">\n" +
    "\n" +
    "                        <h2>Earth Engine</h2>\n" +
    "\n" +
    "\n" +
    "                        <p>Analyze our data on Google Earth Engine.\n" +
    "                        </p>\n" +
    "\n" +
    "                        <p><a class=\"btn btn-danger\" href=\"https://earthengine.google.org/\"\n" +
    "                              role=\"button\">Go to Earth\n" +
    "                            Engine &raquo;</a>\n" +
    "                        </p>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "<div class=\"container-fluid\">\n" +
    "\n" +
    "    <a name=\"Team\" class=\"shifted-anchor\">&nbsp;</a>\n" +
    "\n" +
    ...
    "            <h2>Meet the Team</h2>\n" +
    "\n" +
    "            <p>In 2013, the US Geological Survey’s (USGS) John Wesley Powell Center launched a\n" +
    "                major\n" +
    "                new initiative – an international Working Group on Global Croplands (WGGC) and\n" +
    "                their Water Use for\n" +
    "                Food Security in the Twenty-first Century, led by Dr. Prasad Thenkabail (Research\n" +
    "                Geographer) from\n" +
    "                the USGS. Prasad has assembled a group of scientists from across the world, with\n" +
    "                skills spanning the\n" +
    "                disciplines necessary to grapple with these issues – to harness and share their\n" +
    "                collective knowledge\n" +
    "                on remote sensing, crop modelling, food security, water management and geographical\n" +
    "                information\n" +
    "                management.</p>\n" +
    "        </div>\n" +
    "        <div class=\"col-md-3 hidden-sm hidden-xs\">\n" +
    "            <img class=\"centertte-image img-responsive img-rounded\"\n" +
    "                 src=\"http://cache.croplands.org/static/images/team_photo.jpg\"\n" +
    "                 alt=\"Team Photo\">\n" +
    "        </div>\n" +
    "        <div class=\"col-md-4\">\n" +
    "\n" +
    "            <ul>\n" +
    "                <li>Prasad Thenkabail, PI, USGS</li>\n" +
    "                <li>Cristina Milesi, co-I, NASA AMES\\CSUMB</li>\n" +
    "                <li>Mutlu Ozdogan, co-I, UW</li>\n" +
    "                <li>Russ Congalton, co-I, UNH\n" +
    "                </li>\n" +
    "                <li>Chandra Giri, co-I, USGS EROS\n" +
    "                </li>\n" +
    "                <li>James Tilton, co-I, NASA GSFC\n" +
    "                </li>\n" +
    "                <li>Temuulen Teki, co-I, NAU\n" +
    "                </li>\n" +
    "                <li>Pardhasaradhi Teluguntla, Research Scientist, BAERI\\USGS\n" +
    "                </li>\n" +
    "                <li>Jun Xiong, Post doc, NAU\\USGS\n" +
    "                </li>\n" +
    "                <li>\n" +
    "                    Dr. Murali Krishna Gumma, ICRISAT\n" +
    "                </li>\n" +
    "                <li>Richard Massey, PhD student, NAU/USGS\n" +
    "                </li>\n" +
    "                <li>Aparna Phalke, PhD student, UW\n" +
    "                </li>\n" +
    "                <li>Kamini Yadav, PhD student, UNH\n" +
    "                </li>\n" +
    "                <li>Gu Jianyu, PhD student, UNH\n" +
    "                </li>\n" +
    "                <li>Justin Poehnelt, NAU/USGS\n" +
    "                </li>\n" +
    "\n" +
    "            </ul>\n" +
    "        </div>\n" +
    ...
    "        <div class=\"row\">\n" +
    "            <div class=\"col-sm-3\">\n" +
    "                <img class='center-block img-thumbnail thumbnail-noborder partners'\n" +
    "                     src=\"http://www.usgs.gov/images/header_graphic_usgsIdentifier_white.jpg\"/>\n" +
    "                <img class='center-block img-thumbnail thumbnail-noborder partners'\n" +
    "                     src=\"http://cache.croplands.org/static/images/nasa.jpg\"/>\n" +
    "                <ul class=\"list-unstyled\">\n" +
    "\n" +
    "\n" +
    "                </ul>\n" +
    ...
    "            <div class=\"col-sm-3\">\n" +
    "                <address>\n" +
    "                    <strong>USGS Flagstaff</strong><br>\n" +
    "                    Prasad Thenkabail<br>\n" +
    "                    2255 North Gemini Drive<br>\n" +
    "                    Flagstaff, AZ 86001-1637<br>\n" +
    "                </address>\n" +
    "            </div>\n" +
    "            <div class=\"col-sm-3\">\n" +
    "                <ul class=\"list-unstyled\">\n" +
    "                    <li>\n" +
    "                        <a href=\"mailto:info@croplands.org\" target=\"_top\">Contact</a>\n" +
    "                    </li>\n" +
    "                    <li>\n" +
    "                        <a href=\"http://www.usgs.gov/laws/accessibility.html\"\n" +
    "                           title=\"Accessibility Policy (Section 508)\">Accessibility</a>\n" +
    "                    </li>\n" +
    "                    <li>\n" +
    "                        <a href=\"http://www.usgs.gov/foia/\" title=\"Freedom of Information Act\">Freedom\n" +
    "                            of\n" +
    "                            Information Acts</a>\n" +
    "                    </li>\n" +
    "                    <li>\n" +
    ...
    "                           title=\"Policies and notices that govern information posted on USGS Web sites.\">Policies\n" +
    "                            and Notices</a>\n" +
    "                    </li>\n" +
    "\n" +
    "                </ul>\n" +
...
angular.module("views/map.html", []).run(["$templateCache", function($templateCache) {
...
angular.module("views/reset.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("views/reset.html",
    "<reset-form data-token=\"token\"></reset-form>");
}]);
